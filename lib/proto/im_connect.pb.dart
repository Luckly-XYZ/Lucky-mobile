...
class IMConnectMessage extends $pb.GeneratedMessage {
  ...
  factory IMConnectMessage.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory IMConnectMessage.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IMConnectMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'im'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'code', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'token')
    ..aOM<$0.Any>(3, _omitFieldNames ? '' : 'data', subBuilder: $0.Any.create)
    ..m<$core.String, $core.String>(4, _omitFieldNames ? '' : 'metadata', entryClassName: 'IMConnectMessage.MetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('im'))
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  IMConnectMessage copyWith(void Function(IMConnectMessage) updates) => super.copyWith((message) => updates(message as IMConnectMessage)) as IMConnectMessage;
  ...
  static $pb.PbList<IMConnectMessage> createRepeated() => $pb.PbList<IMConnectMessage>();
  @$core.pragma('dart2js:noInline')
  static IMConnectMessage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IMConnectMessage>(create);
